...
class SegF1Metric(Metric):
    ...
    def __repr__(self):
        ...
        return f"TP: {int(self.tp)} pred: {int(self.pred)} gold: {int(self.gold)} Total: {int(self.pred+self.gold)} \nP: {self.p:6.2%} R: {self.r:6.2%} F: {self.f:6.2%}"
...
class MetricByLength(object):
    ...
    def __init__(self, metric) -> None:
        self.lens = [(1, 2), (2, 3), (3, 4), (4, 5), (5, 7), (7, 1e3)]
