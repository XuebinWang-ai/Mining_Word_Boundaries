...
def main():
    ...
    subparser.add_argument('--use_train2', action='store_true', help='whether to use train2')
    subparser.add_argument('--train2', default='data/ptb/train2.conllx', help='path to train file')
    ...
    subparser.add_argument('--constrained', action='store_true', help='constrained decoding')
    subparser.add_argument('--compute_marg_probs', action='store_true', help='compute marg probs')
    subparser.add_argument('--buckets', default=8, type=int, help='max num of buckets to use')
    subparser.add_argument('--data', default='data/ptb/test.conllx', help='path to dataset')
